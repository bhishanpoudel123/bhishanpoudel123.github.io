...
def load_html_template():
    ...
    template_path = os.path.join(os.path.dirname(__file__), 'html_template_topic_html.html')
    try:
...
def create_topic_html(topic_dir, topic_folder):
    ...
    try:
        ...
        html_template = load_html_template().replace('{{TOPIC_NAME}}', topic_name)
            ...
            try:
                ...
                if 'learning_resources' in question_data and question_data['learning_resources']:
                    ...
                    for resource in question_data['learning_resources']:
                        ...
                        full_path = os.path.normpath(os.path.join(project_root, resource_path) if resource_path.startswith('data/') else os.path.normpath(os.path.join(qn_dir, resource_path)))
        ...
        print(f"🎉 Created topic HTML: {output_file}")
        return output_file
